...
const rules = [
  ...
  ['04', 'Quyền trợ giúp', 'Mỗi đội dùng 2 quyền trong cả game: Mở hồ sơ lịch sử, Hỏi nhà sử học hoặc Loại trừ.'],
...
export default function RulesPage({ onStart }) {
  return <main className="rules-page"><header className="page-heading"><p className="eyebrow">HƯỚNG DẪN VỤ ÁN</p><h1>Luật chơi</h1><p>Thi đấu đồng thời, trao đổi cùng đồng đội và giải mã các dấu mốc lịch sử.</p></header>
    ...
    <section className="aid-box"><div><HelpCircle size={25} /><h2>Ba quyền trợ giúp</h2><p>Mỗi đội tự chọn hai quyền trước khi chơi. Khi dùng quyền, đội vẫn phải chốt đáp án trong thời gian quy định.</p></div><ul><li><b>Mở hồ sơ lịch sử</b><span>Nhận một dữ kiện gợi ý.</span></li><li><b>Hỏi nhà sử học</b><span>Hỏi ban tổ chức trong 15 giây.</span></li><li><b>Loại trừ</b><span>Loại bỏ hai phương án sai.</span></li></ul></section>
